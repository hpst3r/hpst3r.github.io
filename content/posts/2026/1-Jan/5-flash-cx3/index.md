...
Dump the original firmware for a backup. Worst case, you can put the card in recovery mode and reflash it (haven't had to do this yet, so I won't be covering it).
